        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href=<?php echo e(route('root')); ?> class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(URL::asset('/assets/images/logo.webp')); ?>" alt="" width="100%">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('/assets/images/logo.webp')); ?>" alt="" width="100%">
                    </span>
...
<?php /**PATH D:\installed-application\laragon\www\egs-solar-1\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>