...
unset($__errorArgs, $__bag); ?>"
                                        id="client" name="client" placeholder="Client Name" value="<?php echo e(old('client')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        id="start-date" name="start_date" value="<?php echo e(old('start_date')); ?>">
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                        id="due-date" name="due_date" value="<?php echo e(old('due_date')); ?>">
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>"
                                        id="budget" name="budget" value="<?php echo e(old('budget')); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\installed-application\laragon\www\egs-solar\resources\views/admin/projects/create.blade.php ENDPATH**/ ?>