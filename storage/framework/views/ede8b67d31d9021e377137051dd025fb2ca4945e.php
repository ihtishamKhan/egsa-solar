...
unset($__errorArgs, $__bag); ?>"
                                        id="title" name="title" placeholder="Lead title" value="<?php echo e($lead->title); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        id="firstName" name="first_name" placeholder="Enter first name" value="<?php echo e($lead->first_name); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        id="firstName" name="last_name" placeholder="Enter last name" value="<?php echo e($lead->last_name); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        id="contactNumber" name="contact_number" placeholder="Contact number" value="<?php echo e($lead->contact_number); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        class="form-control <?php $__errorArgs = ['additional_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        id="additionalNumber" name="additional_number" placeholder="Additional number" value="<?php echo e($lead->additional_number); ?>">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select id="leadStatus" name="status" class="form-select" <?php if(true): echo 'readonly'; endif; ?> >
                                        ...
                                        <option value="Fresh" <?php echo e($lead->status == "Fresh" ? 'selected' : ''); ?>>Fresh
                                        </option>
                                        ...
                                        <?php echo e($lead->status == "Proposal Sent" ? 'selected' : ''); ?>>
                                            Proposal Sent
                                        </option>
                                        ...
                                        <option value="Cold" <?php echo e($lead->status == 'Cold' ? 'selected' : ''); ?>>Cold
                                        </option>
                                    </select>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Git\egsa-solar\resources\views/admin/leads/edit.blade.php ENDPATH**/ ?>