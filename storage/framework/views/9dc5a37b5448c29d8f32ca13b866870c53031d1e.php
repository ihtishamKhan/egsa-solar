<div class="col-12 mb-4">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e(request()->routeIs('leads.siteSurvey') ? 'active' : ''); ?>"
                href="<?php echo e(route('leads.siteSurvey', $lead->uuid)); ?>" role="tab">
                <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
...
<?php /**PATH D:\Projects\Git\egsa-solar\resources\views/layouts/leads-menu.blade.php ENDPATH**/ ?>