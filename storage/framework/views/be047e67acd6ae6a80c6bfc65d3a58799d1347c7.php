                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p>Sign in to continue to Dépannage</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="<?php echo e(URL::asset('/assets/images/logo.svg')); ?>" alt=""
                                                    class="rounded-circle" height="72">
                                            </span>
                                        </div>
                                    </a>
...
unset($__errorArgs, $__bag); ?>"
                                                value="<?php echo e(old('email', 'admin@depannage.com')); ?>" id="username"
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Web dev\my-projects\depannage\resources\views/auth/login.blade.php ENDPATH**/ ?>