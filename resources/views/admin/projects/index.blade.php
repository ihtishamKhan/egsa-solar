            ...
            <div class="row" style="overflow-x: auto;">
                <div class="col-3">
                    <div class="board">
                        ...
                        <div class="board-body" id="planning">
                            @foreach ($projects->where('status', 'planning') as $item)
                                <div class="board-task" id="{{ $item->id }}">
                                    {{ $item->title }}
                                    <div class="mb-0 font-italic task-info" style="clear: both; display: block;">
                                        <span class=""
                                            style="color: red; float: left;">{{ $item->due_date ? $item->due_date->format('d-m-Y') : '' }}
                                        </span>
                ...
                <div class="col-3">
                    <div class="board">
                        ...
                        <div class="board-body" id="in_progress">
                            @foreach ($projects->where('status', 'in_progress') as $item)
                                <div class="board-task" id="{{ $item->id }}">
                                    {{ $item->title }}
                                    <div class="mb-0 font-italic task-info" style="clear: both; display: block;">
                                        <span class=""
                                            style="color: red; float: left;">{{ $item->duedate ? $item->duedate->format('d-m-Y') : '' }}</span>
                                        <div style="clear: both;"></div>
                                    </div>
                                </div>
                            @endforeach
                ...
                <div class="col-3">
                    <div class="board">
                        ...
                        <div class="board-body" id="review">
                            @foreach ($projects->where('status', 'review') as $item)
                                <div class="board-task" id="{{ $item->id }}">
                                    {{ $item->title }}
                                    <div class="mb-0 font-italic task-info" style="clear: both; display: block;">
                                        <span class=""
                ...
                <div class="col-3">
                    <div class="board">
                        ...
                        <div class="board-body" id="revision">
                            @foreach ($projects->where('status', 'revision') as $item)
                                <div class="board-task" id="{{ $item->id }}">
                                    {{ $item->title }}
                                    <div class="mb-0 font-italic task-info" style="clear: both; display: block;">
                                        <span class=""
                ...
                {{-- <div class="col-3">
                    <div class="board">
                        ...
                        <div class="board-body" id="completed">
                            @foreach ($projects->where('status', 'completed') as $item)
                                <div class="board-task" id="{{ $item->id }}">
                                    {{ $item->title }}
                                    <div class="mb-0 font-italic task-info" style="clear: both; display: block;">
                                        <span class=""
